...
function Tabs() {
    ...
    return (
        <div>
            <div class="border-b border-gray-200 w-[55vw] xnm:w-[100%] dark:border-gray-700  mt-6 bg-white rounded-l" >
            ...
            <div id="myTabContent">
                <div class={active == 1 ? "" : "hidden"} id="profile" role="tabpanel" aria-labelledby="profile-tab"><p>     
